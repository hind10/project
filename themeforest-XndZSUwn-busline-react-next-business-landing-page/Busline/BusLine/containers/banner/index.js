            ...
            <Col md={6}>
              <div className="banner-content">
                <Titlespan
                  ...
                  Label="Construisez un Avenir"
                  Name="financier plus radieux"
                />
                <Description
                  Class="banner-dec"
                  Name="Simple, Transparent et Sécurisé"
                />
                <div className="banner-btn-wrapper">
                  <Button Class="button1 button3 btn" Name="Apprendre Plus" />
                  <Button
                    Class="button1 button4 btn"
                    Name="Demander mon crédit"
