    ...
    switch (e.target.className) {
      case "color1":
        document.body.style.setProperty(
          "--primary",
          "linear-gradient(to right, #ffd216 0%, #ff7b16 100%)"
        );
        document.body.style.setProperty("--primary1", "#ffd216");
        document.body.style.setProperty("--primary2", "#ff7b16");
        document.body.style.setProperty(
          "--primary3",
          "rgba(255, 210, 22, 124)"
        );
        document.body.style.setProperty(
          "--bannerimg",
          "url(/assets/images/banner/bg2.png)"
        );
        break;
      case "color2":
        document.body.style.setProperty(
      ...
      case "color4":
        ...
        document.body.style.setProperty(
          "--bannerimg",
          "url(/assets/images/banner/bg3.png)"
        );
        break;
      case "color5":
        document.body.style.setProperty(
      ...
      case "color6":
        ...
        document.body.style.setProperty(
          "--bannerimg",
          "url(/assets/images/banner/bg5.png)"
        );
        break;
      default:
        break;
